(function () {
  ...
  var DICTIONARIES = {
    en: {
      ...
      "opensource.row5Desc": "ZCode SQLite usage adapter and report/test integration.",
      "opensource.row5Status": "Merged · PR #1675 ↗",
    ...
    ru: {
      ...
      "opensource.row5Desc": "Адаптер ZCode для SQLite и интеграции отчётов и тестов.",
      "opensource.row5Status": "Объединено · PR #1675 ↗",
    ...
    zh: {
      ...
      "opensource.row5Desc": "ZCode SQLite 使用适配器以及报告和测试集成。",
      "opensource.row5Status": "已合并 · PR #1675 ↗",
    ...
    hi: {
      ...
      "opensource.row5Desc": "ZCode SQLite उपयोग एडाप्टर और रिपोर्ट/टेस्ट इंटीग्रेशन।",
      "opensource.row5Status": "मर्ज किया गया · PR #1675 ↗",
