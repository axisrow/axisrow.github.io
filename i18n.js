(function () {
  ...
  var DICTIONARIES = {
    ...
    ru: {
      ...
      "hero.availability": "Доступен для отдельных инженерных проектов",
      ...
      "opensource.eyebrow": "Вклад в open source",
      ...
      "about.copy1": "Я создаю инструменты для AI-агентов, автоматизацию Telegram и системы данных с упором на явное поведение, наблюдаемые сбои и спокойную эксплуатацию.",
