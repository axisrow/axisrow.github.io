...
known allowlisted files, including the vendored Demoscene manifest and bundle
under `assets/demoscene/`. If `.pages-dist` ever contains an unexpected file,
the build fails closed rather than deleting it.
